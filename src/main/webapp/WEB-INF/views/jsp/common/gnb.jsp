...
$(function() {
	...
	commonGnb.addClass('gnb').addClass('width_full_size').addClass('text_center').css('background-color','skyblue');
	...
	commonGnb.find('li:nth-child(2)').click(function(){
		alert('고객 로그인 클릭 했음!!!');
		goPage('${context.path}/login','move','loginForm');
	});
	commonGnb.find('li:nth-child(3)').click(function(){
		alert('스탭 로그인 클릭 했음!!!');
		goPage('${context.path}/staff.do','move','pageloginForm');
	});
